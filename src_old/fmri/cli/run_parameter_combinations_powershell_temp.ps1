...
$INPUT_DIR = "C:\Users\user\Documents\brainWork\fMRI-runs\fMRI-files\files_from_amir_for_test\raw-files"
$PROCESSED_DIR = "C:\Users\user\Documents\brainWork\fMRI-runs\outputs\preprocessed_data"
$BASE_OUTPUT_DIR = "C:\Users\user\Documents\brainWork\fmri-runs\outputs\run_params_comb\fmri_combinations_results_skfda"
